...
export GITOPS_REPO_URL=https://github.com/rhtap-test-organization-jk/qkyks0phi-go-gitops
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.cluster-rp2c9.rp2c9.sandbox637.opentlc.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.cluster-rp2c9.rp2c9.sandbox637.opentlc.com}
